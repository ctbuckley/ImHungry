	...
	<body>
		...
		<div class="main_body_cont">
			...
			<div class="grocery_list_cont">
				<div class="grocery_item_cont">
					<div class="grocery_item">
						<p>1 cookie paijfapifjapdifjapfijapfeija
						pefijapfijapeifjaepfijapefijapfijfpjafpaijefpaijfpaiejfpaifjaeijf</p>
					</div>
					<object class="x-icon" data="/FeedMe/img/x-icon.svg" type="image/svg+xml"></object>
				</div>
				<div class="grocery_item_cont">
					<div class="grocery_item">
						<p>1 cookie paijfapifjapdifjapfijapfeija
